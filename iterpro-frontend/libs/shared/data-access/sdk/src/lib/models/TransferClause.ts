...
export interface TransferClauseInterface {
  "percentage"?: boolean;
  "conditioned"?: boolean;
  "type": string;
  "transferType"?: string;
...
export class TransferClause implements TransferClauseInterface {
  "percentage": boolean;
  "conditioned": boolean;
  "type": string;
  "transferType": string;
  ...
  agent: Agent;
  _conditions: ContractOptionCondition[];
  constructor(data?: TransferClauseInterface) {
  ...
  * @license MIT
  * This method creates an instance of TransferClause for dynamic purposes.
  **/
  public static factory(data: TransferClauseInterface): TransferClause{
    return new TransferClause(data);
  }
  /**
  ...
  **/
  public static getModelDefinition() {
    return {
      name: 'TransferClause',
      plural: 'TransferClauses',
      path: 'TransferClauses',
      idName: 'id',
      properties: {
        "percentage": {
          name: 'percentage',
