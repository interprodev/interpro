...
export interface ContractOptionInterface {
  "type": string;
  "transferType"?: string;
  "amount": number;
  "grossAmount"?: number;
...
export class ContractOption implements ContractOptionInterface {
  "type": string;
  "transferType": string;
  "amount": number;
  "grossAmount": number;
  ...
  agent: Agent;
  _conditions: ContractOptionCondition[];
  constructor(data?: ContractOptionInterface) {
  ...
  * @license MIT
  * This method creates an instance of ContractOption for dynamic purposes.
  **/
  public static factory(data: ContractOptionInterface): ContractOption{
