...
/**
 * Api services for the `CustomerPlayer` model.
 */
@Injectable()
export class CustomerPlayerApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id CustomerPlayer id
   *
   ...
   * </em>
   */
  public getPlayer(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/customerPlayers/:id/player";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries accessTokens of CustomerPlayer.
   *
   * @param {any} id CustomerPlayer id
   *
   * @param {object} filter 
  ...
  public getAccessTokens(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/customerPlayers/:id/accessTokens";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Counts accessTokens of CustomerPlayer.
   *
   * @param {any} id CustomerPlayer id
   *
  ...
  public countAccessTokens(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/customerPlayers/:id/accessTokens/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public changePassword(oldPassword: any, newPassword: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/customerPlayers/change-password";
    let _routeParams: any = {};
    let _postBody: any = {
      data: {
  ...
  public setPassword(newPassword: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/customerPlayers/reset-password";
    let _routeParams: any = {};
    let _postBody: any = {
      data: {
        newPassword: newPassword
   ...
   * </em>
   */
  public sendWelcomeEmail(id: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/customerPlayers/:id/welcome-email";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
   ...
   * </em>
   */
  public resetPlayerAppCredentials(id: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/customerPlayers/:id/reset";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public resetPasswordRequest(email: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/customerPlayers/password-reset";
    let _routeParams: any = {};
    let _postBody: any = {
      data: {
        email: email
  ...
  /**
   * @ngdoc method
   * @name sdk.CustomerPlayer#getCurrent
   * @methodOf sdk.CustomerPlayer
   *
   * @description
   *
  ...
  public getCurrent(filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/customerPlayers" + "/:id";
   ...
   * call to {@link sdk.CustomerPlayer#login} or
   * {@link sdk.CustomerPlayer#getCurrent}. Return null when there
   ...
   * call to {@link sdk.CustomerPlayer#login}
   *
  ...
  /**
   * @name sdk.CustomerPlayer#isAuthenticated
   *
  ...
  /**
   * @name sdk.CustomerPlayer#getCurrentId
   *
