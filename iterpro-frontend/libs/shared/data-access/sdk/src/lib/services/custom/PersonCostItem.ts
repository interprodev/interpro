...
/**
 * Api services for the `PersonCostItem` model.
 */
@Injectable()
export class PersonCostItemApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id PersonCostItem id
   *
  ...
  public findByIdAttachments(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PersonCostItems/:id/attachments/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Queries attachments of PersonCostItem.
   *
   * @param {any} id PersonCostItem id
   *
   * @param {object} filter 
  ...
  public getAttachments(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PersonCostItems/:id/attachments";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Counts attachments of PersonCostItem.
   *
   * @param {any} id PersonCostItem id
   *
  ...
  public countAttachments(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PersonCostItems/:id/attachments/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
