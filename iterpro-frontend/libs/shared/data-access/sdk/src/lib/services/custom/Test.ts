...
export class TestApi extends BaseLoopBackApi {
   ...
   * @param {any} id Test id
   *
   * @param {any} fk Foreign key for instances
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdInstances(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/tests/:id/instances/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
   ...
   */
  public destroyByIdInstances(id: any, fk: any, customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public updateByIdInstances(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public getInstances(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/tests/:id/instances";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createInstances(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
   ...
   * This method returns no data.
   */
  public deleteInstances(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/tests/:id/instances";
    let _routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countInstances(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/tests/:id/instances/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public graphComparison(teamId: any = {}, testModelId: any = {}, date: any = {}, metrics: any = {}, playerIds: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/tests/graphComparison";
    let _routeParams: any = {};
    let _postBody: any = {
      data: {
        teamId: teamId,
   ...
   * </em>
   */
  public graphTrend(teamId: any = {}, testModelId1: any = {}, metrics1: any = {}, testModelId2: any = {}, metrics2: any = {}, dateFrom: any = {}, dateTo: any = {}, playerIds: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/tests/graphTrend";
    let _routeParams: any = {};
    let _postBody: any = {
      data: {
        teamId: teamId,
        testModelId1: testModelId1,
        metrics1: metrics1,
        testModelId2: testModelId2,
        metrics2: metrics2,
        dateFrom: dateFrom,
        dateTo: dateTo,
        playerIds: playerIds
   ...
   * </em>
   */
  public createManyInstances(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/tests/:id/instances";
    let _routeParams: any = {
